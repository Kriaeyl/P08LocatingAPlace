package com.myapplicationdev.android.p08locatingaplace;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                map.addMarker(east);
                //sg = new MarkerOptions()
                        //.position(new LatLng(1.290270, 103.851959));

                //add sg to front of arraylist if needed
        ...
        //Add Singapore to front of array if needed
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                //if (i==0) {
                    //map.moveCamera(CameraUpdateFactory.newLatLngZoom(markers.get(i).getPosition(), 11));
                //} else {
